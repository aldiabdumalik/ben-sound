    ...
    <div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
        <div class="col-lg-6 col-md-7 col-sm-8">
            <div class="feature_image" data-aos="fade-up" data-aos-delay="300">
                <img src="{{ asset('web/images/features/img_9.png') }}" alt="image_not_found">
            </div>
        </div>
        ...
        <div class="col-lg-5 col-md-6 col-sm-8">
            <div class="section_title ml--30">
                ...
                <p class="mb-30" data-aos="fade-up" data-aos-delay="100">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure ex doloremque molestiae esse porro quia delectus alias architecto ducimus modi maxime eveniet deleniti, temporibus nulla veritatis iusto quas maiores id.
                </p>
            </div>
        </div>
    </div>
